...
**Status:** In progress. Phase 3A, Phase 3B1, and Phase 3B2 are complete and merged. Phase 3B3 has not started.
...
**Current checkpoint:** Phase 3B2 — COMPLETE AND MERGED VIA PR #20. Phase 3B3 has not started.
...
**Next action:** perform a fresh Phase 3B3 impact map from the exact current `main`; do not implement Phase 3B3 until that map is reviewed and separately approved.
