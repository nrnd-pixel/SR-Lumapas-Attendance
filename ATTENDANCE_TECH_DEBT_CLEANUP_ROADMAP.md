...
**Status:** In progress. Phase 3A, Phase 3B1, Phase 3B2, and Phase 3B3A are complete and merged. Phase 3B3B has not started.
...
**Next action:** merge this documentation-only Phase 3B3A closure checkpoint after exact-head CI/review verification, then perform a fresh Phase 3B3B impact map from the resulting signed `main`. Do not implement Phase 3B3B until that map is reviewed and explicitly approved.
