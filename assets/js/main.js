...
import { initReportingPopulationSelectors } from './reporting-population.js';
...
initReportingPopulationSelectors();
...
$('dashboardPopulation').addEventListener('change',loadAdminDashboard);
...
$('reportPopulation').addEventListener('change',invalidatePeriodReport);
...
$('statsPopulation').addEventListener('change',loadMonthlyStats);
